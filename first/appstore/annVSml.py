...
#     X_data.append(is_ustr(line.split("||||||")[0]))     #将每一行文件加入到list中
...
from sklearn.metrics import classification_report
lr_model = LogisticRegression(penalty='l2', C=100, max_iter=100)
lr_model.fit(X_trainData, y_trainData)
print("testing data mean accuracy: {0}".format(lr_model.score(X_testData, y_testData)))
print("In training data")
y_train_pred = lr_model.predict(X_trainData)
print(classification_report(y_trainData, y_train_pred))
print("In testing data")
y_test_pred = lr_model.predict(X_testData)
print(classification_report(y_testData, y_test_pred))